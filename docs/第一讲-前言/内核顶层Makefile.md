...
## 为何编译内核模块不可少顶层Makefile

* 顶层Makefile定义了诸多环境变量，典型指明头文件路径，编译选项
* 解决内核模块依赖其他模块
* 定义各个目标入口

Makefile是代码的外部框架，熟悉她会让我们对Linux的代码层次有一定的了解，这对我们深读代码很有帮助。

```
root@ubuntu16x64:/lib/modules/4.4.0-130-generic/build# cat Makefile
VERSION = 4
PATCHLEVEL = 4
SUBLEVEL = 134
EXTRAVERSION =
...
上善若水，止于至善:<https://www.cnblogs.com/amanlikethis/p/3675486.html#lab2>
